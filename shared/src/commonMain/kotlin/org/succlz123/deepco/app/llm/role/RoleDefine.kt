...
object RoleDefine {
    ...
    const val DESC_OPPOSITE_SEX_CHAT = "异性对话技巧"

    val roles = listOf(
        RoleInfo(DESC_PAPAYA_BOT, "你现在是一个友好且乐于助人的AI助手..."),
        RoleInfo(
    ...
    fun getRoleInfo(name: String): RoleInfo? {
        return roles.firstOrNull { it.roleName == name }
    }
}